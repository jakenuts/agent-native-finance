...
export function Layout({ children }: LayoutProps) {
  ...
  // Keep the handoff bookkeeping (side effects) but we intentionally do NOT
  // auto-open the chat sidecar — the dashboard is the home and the chat panel
  // should only appear when the user explicitly opens it.
  useAgentChatHomeHandoff({
    storageKey: "chat",
